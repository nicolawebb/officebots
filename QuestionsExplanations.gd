...
As you know, an investor is coming to the office in a few minutes and will decide if he wants to invest in our company! 
...
["""
When the timer runs out, the employee with most points will win! 
...
When you get close to a character, you can talk with them through the chat window.

You can use the emojis to show your emotions and expressions.""", "Next"],
["""
You can interact with some objects: either bump into it or pick the object by clicking on the highlighted yellow circle on the object.

Some missions are using the objects: be careful to select the correct object and not a similar one. 
""", "Next"],

["""
If you get stuck during the game, you can change your mission but it will cost you 3 points in your total.  
...
func showIntro():
    ...
    for text_btn in INTRO:
        textzone_btn.hide()
        $Tween.interpolate_property(textzone, "percent_visible", 0, 1, 3)
